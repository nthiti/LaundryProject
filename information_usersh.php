...
<section>
    ...
    <div class="container">
    <br><br>
    <a href="booking_user_re_owto.php"><button class="btn btn-outline-primary">ข้อมูลทั้งหมด</button> </a>
    <br><br>
        <div class="h4 text-center alert alert-success mb-10 " role="alert">เลือกวันที่ต้องการ</div>

        <!-- แบบฟอร์มค้นหา -->
        <form method="get" action="booking_user_report_ow.php" class="form-inline mb-3">
