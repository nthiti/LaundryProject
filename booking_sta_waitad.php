...
WHERE payment.status_payment = '1' AND payment.status_work = '0'  
                ...
                <ul>
                  <li>
                    ...
                    <div class="container">
                      ...
                      <br>
                      <div>
                      <a href = "booking_sta_ad.php"><button type="button" class="btn btn-outline-info">รายการทั้งหมด</button></a>
                      <a href = "booking_sta_finad.php"><button type="button" class="btn btn-outline-success">ทำรายการเสร็จสิ้น</button></a>
                      <a href = "booking_sta_waitad.php"><button type="button" class="btn btn-outline-primary">รอดำเนินการ</button></a>
                      <a href = "booking_sta_staad.php"><button type="button" class="btn btn-outline-warning">รอการตรวจสอบ</button></a>
                      </div>
                            <div class="card-body">
