...
<section>
    ...
    <div id="main">
      ...
      <div id="welcome" >
        ...
        <a href = "booking_new.php"><button type="button" class="btn btn-outline-success padding-5">จองบริการ
          <br> ขนาด 10.5 kg. <br> เหมาสำหรับผ้าไม่เกิน 20 ชิ้น <br> ชุดผ้าห่ม ขนาด 3.5 ฟุต
        </button></a>
        <a href = "booking01.php"><button type="button" class="btn btn-outline-success">จองบริการ
