  ...
  <body>
    ...
    <div id="main">
      ...
      <div class="row">
                            <div class="col-xl-3 col-md-6">
                                <div class="card custom-card1 text-white mb-4">
                                    <div class="card-body">
                                    <a href = "booking_sta_owner.php " class="text-white" >
                                        <?php
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card custom-card text-white mb-4">
                                    <div class="card-body">
                                    <a href = "report_sale1.php" class="text-white" >
                                    <?php
                                        // คำสั่ง SQL เพื่อรวมยอดเงิน
                                        $sql = "SELECT SUM(Total) AS total_amount FROM booking";
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card custom-card3 text-white mb-4">
                                    <div class="card-body">
                                    <a href = "information_user_ow.php" class="text-white" >
                                        <?php
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card custom-card2 text-white mb-4">
                                    <div class="card-body">
                                    <a href = "owner_show_repair.php" class="text-white" >
                                    <?php
                                           // คำสั่ง SQL สำหรับการนับจำนวนแถวที่มีค่า "user" ในคอลัมน์ "role"
      ...
      <h2 class = "mt-10"> <?php
                        ...
                        echo "Welcome , Owner " . $_SESSION["firstname"] . " 🎉";
                        echo "</div>";
                        }?></h2>
        <a href = "pagepost.php"><button class="btn1">
        <img src="https://cdn-icons-png.flaticon.com/128/2333/2333043.png" 
        width =  50 height = 50> <br>
        โพสต์ข่าวสาร</button></a>
        <a href = "pagepromotion.php"><button class="btn1">
        <img src="https://cdn-icons-png.flaticon.com/128/1260/1260198.png" 
        width =  50 height = 50> <br>
        โปรโมชั่น</button></a>
        <a href = "information_user_ow.php"><button class="btn1">
        <img src="https://cdn-icons-png.flaticon.com/128/1256/1256650.png" 
        width =  50 height = 50> <br>
        รายชื่อลูกค้า</button></a>
        <a href = "report_sale1.php"><button class="btn1">
        <img src="https://cdn-icons-png.flaticon.com/128/781/781835.png" 
        width =  50 height = 50> <br>
        รายรับ</button></a>
        <a href = "pagemachine.php"><button class="btn1">
        <img src="https://cdn-icons-png.flaticon.com/128/1721/1721929.png" 
        width =  50 height = 50> <br>
        ข้อมูลอุปกรณ์</button></a>
        <a href = "booking_sta_owner.php"><button class="btn1">
        <img src="https://cdn-icons-png.flaticon.com/128/2907/2907150.png" 
        width =  50 height = 50> <br>
        สถานะการจอง</button></a>
        <a href = "pagereport.php"><button class="btn1">
        <img src="https://cdn-icons-png.flaticon.com/128/3534/3534066.png" 
        width =  50 height = 50> <br>
        รายงาน</button></a>
        <a href = "owner_show_repair.php"><button class="btn1">
