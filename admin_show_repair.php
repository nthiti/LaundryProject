...
<section>
                ...
                <ul>
                  <li>
                    ...
                    <div class="container">
                      ...
                      <br>
                      <div>
                      <a href = "admin_show_repair.php"><button type="button" class="btn btn-outline-info">รายการทั้งหมด</button></a>
                      <a href = "repair_ad_fin.php"><button type="button" class="btn btn-outline-success">ทำรายการเสร็จสิ้น</button></a>
                      <a href = "repair_ad_wait.php"><button type="button" class="btn btn-outline-primary">รอดำเนินการ</button></a>
                      </div>
        <br>
        <a href="admin_add_repair.php" class="btn btn-success mb-4">เพิ่มการแจ้งซ่อม</a>
        <div class="table-responsive">
            ...
            <table class="table table-bordered">
                ...
                <?php 
                $sql = "SELECT * FROM repair WHERE DATE(notify_date) = CURDATE() ORDER BY repair.notify_date DESC";
                ...
                <tr>
                    ...
                    <td><a href="admin_edit_repair.php?id=<?= $row["id"] ?>" class="btn btn-warning">Edit</a></td>
                    <td><a href="admin_delect_repair.php?id=<?= $row["id"] ?>" class="btn btn-danger" onclick="Del(this.href);return false";>Delete</a></td>
                </tr>
                <?php
                    $counter++;
                }
        ...
        <div class="table-responsive">
            ...
            <table class="table table-bordered">
                ...
                <?php 
                $sql_old = "SELECT * FROM repair WHERE DATE(notify_date) <> CURDATE() ORDER BY repair.notify_date DESC";
                ...
                <tr>
                    ...
                    <td><a href="admin_edit_repair.php?id=<?= $row_old["id"] ?>" class="btn btn-warning">Edit</a></td>
                    <td><a href="admin_delect_repair.php?id=<?= $row_old["id"] ?>" class="btn btn-danger" onclick="Del(this.href);return false";>Delete</a></td>
                </tr>
                <?php
                    $counter_old++;
                }
