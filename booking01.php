...
<section>
          <div class="circle"></div>
            <header>
                <a href = "service.php" class ="logo"><img src = "img/pic6.png"
        ...
        if (td2) {
            ...
            if (txtValue2.toUpperCase().indexOf(filter) > -1) {
                ...
                tr[i].style.display = "none";
                  ...
                  <div class="textbox">
                  <form action="booking_db.php" method="post" onSubmit="return fncSubmit()">
                  ...
                  <h2> <?php
                    ...
                    <input type="date" name="selected_date" id="selected_date" class="form-control" required min="<?php echo date('Y-m-d'); ?>" max="<?php echo date('Y-m-d', strtotime('+1 day')); ?>">
