...
@import url('https://fonts.googleapis.com/css2?family=Itim&display=swap');
  ...
  <section>
        <header>
        <a href = "pagepromotion.php" class ="logo"><img src = "img/pic6.png"
...
<div class="h4 text-center alert alert-success mt-5 mb-10 " role="alert">
  ...
  <form action="insert_promotion.php" method="post">
                <label>ราคา</label>
                    <input type="number" placeholder="..ราคา" name="point" class="form-control" maxlength="2" required ><br>
                <label>ส่วนลด</label>
                    <input type="number" placeholder="..ส่วนลด" name="discount" class="form-control" required ><br>
