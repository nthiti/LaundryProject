...
<div class="h4 text-center alert alert-success mt-5 mb-10 " role="alert">
  ...
  <form action="insert_wash.php" method="post">
                <label>น้ำหนักเครื่อง</label>
                <input type="float" placeholder="น้ำหนักเครื่อง" name="machine_weight" class="form-control" maxlength="5" required > <br>
                <label>หมายเลขเครื่อง</label>
                    <input type="text" placeholder="หมายเลขเครื่อง" name="machine_number" class="form-control" maxlength="2" required ><br>
                <label>ราคาน้ำเย็น</label>
                    <input type="number" placeholder="ราคาน้ำเย็น" name="machine_price_cool" class="form-control" required ><br>
                <label>ราคาน้ำอุ่น</label>
                    <input type="number" placeholder="ราคาน้ำอุ่น" name="machine_price_warm" class="form-control" required ><br>
                <label>ราคาน้ำร้อน</label>
                    <input type="number" placeholder="ราคาน้ำร้อน" name="machine_price_hot" class="form-control" required ><br>
