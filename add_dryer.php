...
@import url('https://fonts.googleapis.com/css2?family=Itim&display=swap');
  ...
  <section>
        <header>
        <a href = "show_dryer.php" class ="logo"><img src = "img/pic6.png"
...
<div class="h4 text-center alert alert-success mt-5 mb-10 " role="alert">
  ...
  <form action="insert_dryer.php" method="post">
  <label>น้ำหนักเครื่อง</label>
                ...
                <label>ราคา</label>
                    <input type="number" placeholder="ราคา" name="price" class="form-control" required ><br>
                <div class="from-group mb-3" >
                        <label for = "Status_m" >สถานะเครื่องอบผ้า</label>
                        <select name="status" class="form-control" id="select" required >
                            <option value="0">--กรุณาเลือกสถานะเครื่องอบผ้า--</option>
                    ...
                    <a href = "show_dryer.php" class="btn btn-danger mt-2"> ยกเลิก </a>
            </form>
    </div>
</body>
</html>
