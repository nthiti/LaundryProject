...
<section>
        ...
        <div class="table-responsive">
            ...
            <table class="table table-bordered">
                ...
                <?php 
                $sql = "SELECT * FROM repair WHERE DATE(notify_date) = CURDATE() AND repair.status = 'FINISH' 
        ...
        <div class="table-responsive">
            ...
            <table class="table table-bordered">
                ...
                <?php 
                $sql_old = "SELECT * FROM repair WHERE DATE(notify_date) <> CURDATE() AND repair.status = 'FINISH' 
                ORDER BY repair.notify_date DESC";
