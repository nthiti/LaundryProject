...
<a href = "add_dryer.php" class="btn btn-success mb-2"> เพิ่มเครื่องอบผ้า </a>
<table class="table table-bordered">
      <tr>
       <th>น้ำหนักเครื่อง</th>
       <th>หมายเลขเครื่อง</th>
        <th>ราคา</th>
        <th>สถานะเครื่องอบผ้า</th>
        <th>แก้ไข</th>
        <th>ลบ</th>
      </tr>
      <?php
  $sql = "SELECT * FROM dryer";
  ...
  while($row = mysqli_fetch_array($result)){
    $status = $row["status"];
      ...
      <td><a href = "edit_dryer.php?id=<?=$row["id"]?>" class="btn btn-outline-success "> Edit </a></td>
      <td><a href = "delete_dryer.php?id=<?=$row["id"]?>" class="btn btn-outline-danger" onclick = "Del(this.href);return false;"> Delete </a></td>
    </tr>
    <?php
  }
